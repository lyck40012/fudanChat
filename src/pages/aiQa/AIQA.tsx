            ...
            {cameraStatus === 'captured' && capturedImage && (
              <div className={styles.capturedPreview}>
                ...
                <div className={styles.capturedControls}>
                  <button onClick={retakePhoto} className={`${styles.controlButton} ${styles.retakeButton}`}>
                    <div className={styles.controlButtonIcon}>
                      <RotateCcw />
                    </div>
                    <span>重拍</span>
                  </button>
                  <button onClick={confirmUpload} className={`${styles.controlButton} ${styles.confirmButton}`}>
                    <div className={styles.controlButtonIcon}>
                      <Check />
                    </div>
                    <span>确认上传</span>
